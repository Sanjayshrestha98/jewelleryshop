        ...
        <section className="py-12 ">
            ...
            <div className="max-w-7xl px-4 mx-auto">
                <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-5">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900">Cart Page</h1>
                </div>
                                                    ...
                                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                                        ...
                                                        <div className=" flex items-center">
                                                            <div className=" rounded-sm flex gap-3 items-center bg-white">
                                                                ...
                                                                }} className="p-2 cursor-pointer border border-gray-200 text-gray-600 hover:text-red-400 hover:border-red-400  transition duration-200">
                                                                ...
                                                                <button onClick={() => {
                                                                    addItem(value?._id)
                                                                }} className="p-2 cursor-pointer border border-gray-200 text-gray-600 hover:text-green-600 hover:border-green-600 transition duration-200">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewbox="0 0 16 17" fill="none">
...

                    {
                        ...
                        <div className="w-full md:w-1/2 px-4 py">
                            <div className="bg-white rounded shadow-md p-6">
                                <h2 className="text-gray-700 text-lg mb-4 font-semibold">Bill</h2>
                                ...
                                <div className="flex items-center justify-between flex-wrap gap-2 mb-4 mt-10">
                                    <label className="text-gray-700 font-semibold text-lg">Grand Total</label>
